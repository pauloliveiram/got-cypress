it("Validar o método GET do endpoint /houses/{id}", () => {
  cy.request("/houses/10").then(response => {
    ...
    expect(response.body.url).to.include("https://www.anapioficeandfire.com/api/houses/");
    ...
    expect(response.body.overlord).to.include("https://www.anapioficeandfire.com/api/houses/");
